...
export default function WhatsAppButton() {
  const phoneNumber = "+94770000000"; // Replace with your studio WhatsApp number
  ...
  return (
    <motion.a
      ...
      whileTap={{ scale: 0.95 }}
      className="fixed bottom-6 right-6 z-50 bg-[#25D366] text-white p-3.5 rounded-full shadow-2xl flex items-center justify-center border-2 border-white cursor-pointer group"
