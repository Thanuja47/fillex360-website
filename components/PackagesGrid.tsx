      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <Reveal delay={0}>
          <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
            <span className="text-xs font-bold text-orange uppercase tracking-wider bg-orange-soft px-3.5 py-1.5 rounded-full border border-orange/20 inline-block">
        ...
        >
          {t.packagesList.map((pkg, i) => {
            const isFeatured = pkg.featured;
            const isPopular = pkg.popular;
            const hoverLift = isFeatured ? -8 : -6;
        ...
        {/* Custom Quote Banner */}
        <Reveal delay={0.3}>
          <div className="mt-16 text-center bg-panel border border-line p-8 rounded-3xl">
